...
WHERE
    --③資格：栄養士、管理栄養士、調理師
     (
        strpos(crQual.licenseid,'/15038/') > 0
        or strpos(crQual.licenseid,'/15039/') > 0
        or strpos(crQual.licenseid,'/21004/') > 0
    )
	/*
	21004	調理師
	15038	管理栄養士
	...
	*/
    ...
    -- (
    --     crQual.licenseid like '%/15038/%'
    --      or crQual.licenseid like '%/15039/%'
    --      or crQual.licenseid like '%/21004/%'
    -- )
