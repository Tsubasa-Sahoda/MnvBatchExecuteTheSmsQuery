...
with v_career as (
    ...
    */
    ...
    -- Careerindex（薬剤師）、日経DIキャリア、薬キャリ、薬剤師求人.com、ユアジョブ薬剤師、知人等からの紹介、空欄
    and (
        crBase.media_id in(5,12,14,16,85,158,129,0)
    ...
    */
    ...
    --流入経路：その他(110)、紹介(3)、薬剤師(101)、空欄
    and (
        crBase.routeapply_id in (101,110,3,0)
        or crBase.routeapply_id is null
        )

    -- 稼働サービス領域 ：薬剤師、その他、空欄
    and (
        crBase.active_service_field_id in (2,9,0)
